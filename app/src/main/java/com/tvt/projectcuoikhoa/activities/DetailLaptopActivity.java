...
public class DetailLaptopActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tvRating, tvEmty, tvSumStar5, tvSumStar4, tvSumStar3, tvSumStar2, tvSumStar1, tvSumDanhGia, tv_average_rating;
    ...
    private ListView listViewRating, listViewComment;
    ...
    private void addItemToCard(final Spinner spinner) {
        Animation animation = AnimationUtils.loadAnimation(DetailLaptopActivity.this, R.anim.shake_anim_image);
                ...
                if (HomeFragment.arrCart.size() > 0) {
                    ...
                    for (int i = 0; i < HomeFragment.arrCart.size(); i++) {
                        if (HomeFragment.arrCart.get(i).getId_sp() == Integer.parseInt(id)) {
                            ...
                            Log.d("SSSSSSSSSSSSSSSSS", "laptop2: " + HomeFragment.arrCart.get(i).getSoluong());
                        }
...
//                        }
                    ...
                    if (exists == false) {
                        ...
                        if (MainActivity.key == 1) {
                            ...
                            Log.d("SSSSSSSSSSSSSSSSS", "laptop3: " + cart.getSoluong());
...
//
                    ...
                    if (MainActivity.key == 1) {
                        ...
                        HomeFragment.arrCart.add(cart);
                        Log.d("SSSSSSSSSSSSSSSSS", "laptop1: " + cart.getSoluong());
                        //  shoppingCartHelper.insertCart(cart);
                        PostAndUpdateCartToService.postCartToService(cart);
                        tvCount.setText(String.valueOf(HomeFragment.arrCart.size()));
                    } else if (MainActivity.key == 2) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView tvRating = findViewById(R.id.tvRating);
    ...
    private void initViews() {
        ...
        listViewRating = findViewById(R.id.list_rating);
    ...
    private void getIntents() {
        ...
        arrRating = bundle.getParcelableArrayList("ratingLaptop");
        arrComment = bundle.getParcelableArrayList("commentlap");
    ...
    private void getRating(List<Rating> arrRating) {
        ...
        Log.v("UrlBanner", "SizeLaptop: " + arrRatingR.size());
        adapter = new ListRatingAdapter(this, arrRatingR);
        listViewRating.setAdapter(adapter);
        listViewRating.setOnTouchListener(new View.OnTouchListener() {
            // Setting on Touch Listener for handling the touch inside ScrollView
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                // Disallow the touch request for parent scroll on touch of child view
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.share_detail:
                        Toast.makeText(DetailLaptopActivity.this, "A", Toast.LENGTH_SHORT).show();
                        break;
                }
                return false;
            }
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (response.isSuccessful()) {
                    if (mess.equals("success")) {
                        Toast.makeText(DetailLaptopActivity.this, "Đánh giá thành công.Vui lòng refresh trang để cập nhật", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(DetailLaptopActivity.this, "Lỗi!", Toast.LENGTH_SHORT).show();
                    }
                }
